...
function loadBibleData() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filePath = path.join(__dirname, "..", "data", "bible.json");
...
var bibleDataPromise = loadBibleData();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    bibleData = _a.sent();
                    return [2 /*return*/, bibleData.hasOwnProperty(bookName)];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    bibleData = _a.sent();
                    return [4 /*yield*/, isValidBook(bookName)];
                case 2:
                    if (!(_a.sent())) {
                        return [2 /*return*/, false];
                    }
                    book = bibleData[bookName];
                    return [2 /*return*/, book.hasOwnProperty(chapterNumber)];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, bibleDataPromise];
                case 2:
                    bibleData = _a.sent();
                    chapter = bibleData[bookName][chapterNumber];
                    return [2 /*return*/, verseNumber >= 1 && verseNumber <= chapter.length];
            }
        });
    });
}
